...
public class ExamSubmission {
   ...
   */
  public ExamSubmission(List<@Valid ExamSubmissionAnswersInner> answers) {
    this.answers = answers;
  }

  public ExamSubmission answers(List<@Valid ExamSubmissionAnswersInner> answers) {
    this.answers = answers;
    return this;
  }

  public ExamSubmission addAnswersItem(ExamSubmissionAnswersInner answersItem) {
  ...
  public boolean equals(Object o) {
    ...
    ExamSubmission examSubmission = (ExamSubmission) o;
    return Objects.equals(this.answers, examSubmission.answers);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExamSubmission {\n");
